          ...
          <div className="relative h-62 w-full mb-3 p-2">
            <div className="text-center pt-5">
              <input 
                    ...
                    {...register("avatar")}
              />
              <label className={classnames("transition duration-300 bg-gradient-to-br rounded-xl hover:opacity-75")} style={{cursor: "pointer"}} htmlFor="avatar">Select Avatar</label>
