    ...
    <div className="mb-20">
      <div className="container mx-auto">
        ...
        <form
          ...
          className=" relative h-full flex flex-col bg-gray-900 shadow-xl rounded-md mt-3 border-2 border-gray-200 border-opacity-25 pb-3"
        >
          {data.id && (
                ...
                <div className=" ml-24 mr-24 items-center justify-center">
                  ...
                  <div className="flex flex-wrap items-stretch w-full mb-4 relative">
                    <div className="flex -mr-px">
                      <span className="flex items-center leading-normal bg-gray-600 text-white rounded border border-gray-600 shadow-inner py-3 px-5 whitespace-no-wrap text-grey-dark ">
